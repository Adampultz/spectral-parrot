              ...
              for (int i = 0; i < NUM_MOTORS; i++) {
                ...
                if (isMoving[i]) {
                  ...
                  if (millis() - movementStartTime[i] > accelerationTime) {
                    ...
                    //   variance += diff * diff;
                    // }
                    // variance = variance / varianceSize;
                    ...
                    if (mean < sgThreshold) {
                       ...
                       Serial.print("Motor ");
                    Serial.print(i + 1);
                    Serial.print(" Low mean SG: ");
                    Serial.println(mean);
                    }
                    // if (variance > variance_threshold) {
                    //     // Before stopping, log the actual SG values
                    //     Serial.print("Motor ");
                    //     Serial.print(i + 1);
                    //     Serial.print(" HIGH VARIANCE DETECTED: ");
                    //     Serial.print(variance);
                    //     Serial.print(" | SG History: ");
                    //     for (int j = 0; j < varianceSize; j++) {
                    //         Serial.print(sgHistory[i][j]);
                    //         Serial.print(" ");
                    //     }
                    //     Serial.print("| Current SG: ");
                    //     Serial.println(stallGuardResult[i]);
                        
                    //     // Don't stop immediately - wait for confirmation
                    //     static int varianceHighCount[NUM_MOTORS] = {0};
                    //     varianceHighCount[i]++;
                        
                    //     if (varianceHighCount[i] >= 10) {  // Need 3 consecutive high variances
                    //         stopMotor(i);
                    //         varianceHighCount[i] = 0;
                    //         // ... rest of stop code
                    //     }
                    // } else {
                    //     // Reset counter if variance is normal
                    //     static int varianceHighCount[NUM_MOTORS] = {0};
                    //     varianceHighCount[i] = 0;
                    // }
                  }
